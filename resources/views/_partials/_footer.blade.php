...
<footer class="footer-area sub-bg">
    <div class="footer__shape-left">
        <img src="{!! asset('assets/images/shape/footer-shape-left.png') !!}" alt="shape">
    </div>
    <div class="footer__shape-right sway_Y__animationY">
        <img src="{!! asset('assets/images/shape/footer-shape-right.png') !!}" alt="shape">
    </div>
    <div class="container">
        <div class="footer__wrp pt-100 pb-100">
            <div class="footer__item footer-about wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                ...
                <ul class="mt-25">
                    <li>
                        <svg class="me-1" width="15" height="20" viewBox="0 0 16 20" fill="none"
                        ...
                        <a href="#0" class="p-0">Pointe Noire,République du congo</a>
                    </li>
                    <li>
                        ...
                        <a href="tel:+242044117998" class="p-0">(+242) 044117998/069008845</a>
                    </li>
                </ul>
            </div>
            <div class="footer__item item-sm wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <h3 class="footer-title">{!! __('site.quick_link') !!}</h3>
                <ul>
                    <li><a href="{!! route('about') !!}"><i class="fa-regular fa-angles-right me-1"></i>About Guen's</a></li>
                    <li><a href="{!! route('service') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.our_service') !!}</a>
                    </li>
                    <li><a href="{!! route('destination') !!}"><i class="fa-regular fa-angles-right me-1"></i>{!! __('site.our_destination') !!}</a>
                    </li>
                    <li><a href="{!! route('partenaire') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.our_partner') !!}</a>
                    </li>
                    <li><a href="{!! route('representation_rdc') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.our_representation') !!}</a></li>
                    <li><a href="{!! route('faq') !!}"><i class="fa-regular fa-angles-right me-1"></i> FAQ</a></li>
                    <li><a href="{!! route('contact') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.contact_us') !!}</a></li>
                </ul>
            </div>
            <div class="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <h3 class="footer-title">Services</h3>
                <ul>
                    <li><a href="{!! route('orientation_academique') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.service.orientation_cademique') !!}</a></li>
                    <li><a href="{!! route('coaching') !!}"><i class="fa-regular fa-angles-right me-1"></i>
                            {!! __('site.service.coaching') !!}</a>
                    </li>
                    <li><a href="{!! route('procedure_consulaire') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.service.procedure_consulaire') !!}</a>
                    </li>
                    <li><a href="{!! route('assurance') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.service.assurance') !!}</a></li>
                    <li><a href="{!! route('reservation_billet') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.service.reservation_billet_avion') !!}</a></li>
                    <li><a href="{!! route('aide_logement') !!}"><i class="fa-regular fa-angles-right me-1"></i> {!! __('site.service.aide_au_logement') !!}</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            <div
                ...
                <p class="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">&copy; All Copyright 2024
                    by <a href="#0" class="primary-color">GUEN'S</a></p>
